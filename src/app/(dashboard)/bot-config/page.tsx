...
export default async function BotConfigPage() {
  ...
  for (const s of settings) initialConfig[s.key.replace("bot.", "")] = s.value;
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">AI Config</h1>
          <p className="text-slate-500 text-sm mt-0.5">ปรับแต่งบุคลิกและ prompt ของ Daniel HR Bot</p>
        </div>
      </div>
